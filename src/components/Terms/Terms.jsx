  ...
  return (
    <div className="text-left lg:ml-28 mt-56 lg:w-[45em]">
      <h1 className="text-[#192733] text-[50px] font-bold pb-5 space-y-4 mx-8">
        {" "}
        Terms & Condition <br /> Terms and Condition
      </h1>
      <p className="mx-8">Effective date: April 04, 2023.</p>
      <div className="mx-8">
        ...
        <p className="text-black">
          ...
          Service, you agree to this policy's collection and use of information.
          ...
          accessible from <br />
          <a className="text-blue-600 bg-gray-200 underline">
            www.deshcareer.com
          </a>{" "}
        </p>
      </div>
      <div className="mx-8">
        <h6 className="font-bold my-6 text-black">
      ...
      <div className="mx-8">
        <h6 className="font-bold my-6 text-black">Types of data collected</h6>
        <p className="text-black  mt-12">Personal Data</p>
      ...
      <div className="mx-8 ">
        <p className="text-black">Usage Data</p>
      ...
      <div className="mx-8  mt-12">
        <p className="text-black">Tracking & Cookies Data</p>
      ...
      <div className="mx-8  mt-12">
        <p className="text-black">Use of Data</p>
        <p className="text-black my-5">
      ...
      <div className="mx-8">
        <p className="text-black">Transfer Of Data</p>
            ...
            <li>
              ...
              <span>
                <a
                  ...
                  href="https://deshcareer.com/privacy/www.banglapuzzle.com"
                >
                  Bangla Puzzle
                </a>
              </span>
      ...
      <div className="mx-8">
        <p className="text-black">Security Of Data</p>
      ...
      <div className="mx-8">
        <p className="text-black">Service Providers</p>
      ...
      <div className="mx-8  mt-12">
        <p className="text-black">Link to Other Sites</p>
      ...
      <div className="mx-8 mt-12">
        <p className="text-black">Changes To This Privacy Policy</p>
        ...
        <p className="text-black my-5">
          ...
          Service before the change becomes effective and update the "effective
      ...
      <div className="mx-8">
        ...
        <p className="text-black my-5">
          ...
          us: contact.deshcareer@gmail.com
        </p>
      </div>
    </div>
  );
